...
preview: "/images/portraits/pg-1992864343709663397.jpg"
---
...
```json
{
  "image_generation_prompt": {
    ...
    "lighting": {
      ...
      "effects": [
        "Realistic rain reflections on wet asphalt"
      ]
    },
    "environment": {
...
- [Original Post](https://twitter.com/lexx_aura/status/1992864343709663397)

## Example Output

![Rainy Night Whimsy: Totoro at the Bus Stop](/images/portraits/pg-1992864343709663397.jpg)
