...
- **Brand Customization**: Replace [BRAND NAME] with any luxury brand (Hermès, Louis Vuitton, Gucci, etc.)
- **Studio Setup**: Soft pastel background with professional softbox lighting
- **Texture Focus**: Premium pebbled leather with visible texture
- **Hardware Details**: Polished metal hardware and leather luggage tag
- **Photography Style**: Editorial, shallow depth of field, sharp focus on product
- **Typography**: Minimalist brand text at bottom

## Customization Ideas

| Brand | Color Palette | Patterns/Motifs |
|-------|---------------|-----------------|
| Hermès | Orange, Burgundy | Horse carriage, H logo |
| Louis Vuitton | Brown, Gold | LV monogram, Damier |
| Gucci | Green, Red | GG pattern, Flora |
| Prada | Black, Blue | Triangle logo |
| Chanel | Black, White | CC logo, Quilted |

## Source
- [Original Post](https://x.com/AmirMushich/status/2002274024408191033)

## Example Output
![Luxury Leather Duffle Bag Editorial](/media/creative/luxury-leather-duffle-bag-editorial.jpg)
